...
public class PutActionTest extends TestCase
{

	private static Logger log = LoggerFactory.getLogger(PutActionTest.class);
	...
	IllegalAccessException, InvocationTargetException, NoSuchMethodException, BadXMLException
	{
		...
		String page = "<pager:put key=\"put-content\">This is the 1st put content</pager:put>"
		...
		assertEquals("put-content:This is the 1st put content", newPage);
	}
