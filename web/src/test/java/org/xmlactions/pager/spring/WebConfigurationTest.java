...
public class WebConfigurationTest extends TestCase {
	...
	private static Logger log = LoggerFactory.getLogger(WebConfigurationTest.class);

	// FIXME must use spring-pager-startup.xml also
	...
	public void testConfigurationFactory() throws ConfigurationException {
		...
		URL url = WebConfigurationTest.class.getResource(configFileName);
