...
public class OracleSelectQuery implements ISqlSelectBuildQuery {
    ...
    public String buildSelectQuery(IExecContext execContext, ISelectInputs iSelect, List<SqlField> sqlParams) {
        ...
        if (iSelect.getLimitFrom() != null) {
            ...
            sb.append(" )\n");
            sb.append(")\n");
            if (iSelect.getLimitFrom() != null && iSelect.getLimitTo() != null) {
                sb.append("where rnum between " + iSelect.getLimitFrom() + " and " + iSelect.getLimitTo());
            }
        } else {
    ...
    public String buildInnerSelect(ISelectInputs iSelect, boolean inside) {
        ...
        addWhereClauses(sb, iSelect, null, null);
    ...
    private void addWhereClauses(StringBuilder sb, ISelectInputs iSelect, String limitFrom, String limitTo) {
        ...
        if (limitFrom != null) {
            if (addedWhere == false) {
                sb.append(" where " + limitFrom);
            } else {
                sb.append(" and " + limitFrom);
            }
        }
        if (limitTo != null) {
            if (addedWhere == false) {
                sb.append(" where " + limitTo);
            } else {
                sb.append(" and " + limitTo);
            }
        }
    }
